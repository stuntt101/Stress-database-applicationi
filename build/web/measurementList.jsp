        ...
        <div  class="container" style="height:560px; overflow: auto;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table id="bootstrap" style="float: left; display: block;">
                        <tr>
                                ...
                                <c:forEach items="${listStressMeasurements}" var="list">
                                    ...
                                    <tr >
                                        ...
                                        <td nowrap align="center"><c:out value="${list.notes}" /></td>
                                         ...
                                         <td nowrap align="center"> <a href="DownloadServlet?action=download&smId=<c:out value="${list.smId}"/>" >Download</a></td>
