<%-- 
    Document   : editUser
    Created on : 01 Feb 2017, 10:34:06 AM
    Author     : LQwabe
--%>
...
//            });
    ...
    <body>
        ...
        <div id="container">
            <div class="shell">
                <!-- Small Nav -->
                <div class="small-nav"> <a href="measurementList_ad.jsp">Home</a> <span>&gt;</span>Edit User</div>
                <!-- End Small Nav -->
            </div>
            <!-- Content -->
            <center>
                <div id="login" style="width: 1000px;height: 400px; ">
                    ...
                    <div class="box">
                        <!-- Box Head -->
                        <div class="box-head">
                            <h2 class="left"><strong>Edit User</strong></h2>
                        </div>
                        <!-- End Box Head-->
                                        ...
                                        <center>
                                            <form  id="register_user"    action ="RegisterUser"method="POST"  autocomplete="off">
                                                <table border="0" cellpadding = "2" cellspacing="7">
                                                    <tbody>
                                                        <tr>
                                                            <td><label>Username<span  style="color:red">*</span></label></td> <td><input type="text" name="username" maxlength="45" class="form-control"  value="${edituser.username}" readonly/></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label>Password<span  style="color:red">*</span></label></td> <td><input type="text" id="password"  name="password" maxlength="45" class="form-control"  value="${edituser.password}"/></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label>First Name<span  style="color:red">*</span></label></td> <td><input type="text" id="firstName" name="firstName" maxlength="45" class="form-control" value="${edituser.firstname}"/></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label>Last Name<span  style="color:red">*</span></label></td> <td><input type="text"  id="lastName" name="lastName" maxlength="45" class="form-control" value="${edituser.lastname}"/></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label>Email Address<span  style="color:red">*</span></label></td> <td><input type="text" id="emailAddress"   name="emailAddress" maxlength="45" value="${edituser.emailAddress}" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label>Mine Name<span  style="color:red">*</span></label></td> <td><input type="text" id="mineName" name="mineName" maxlength="45"  value="${edituser.mineName}"  /></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td></td> <td><button  class="button" name ="action" value="updateUser"  >Update</button> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<button  class="button" name ="action" value="Close">Close</button></td>
                                                        </tr>
