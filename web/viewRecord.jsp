            ...
            <center>
                <div id="login" style="width: 1000px;height: 800px; ">
                    ...
                    <div class="box">
                        <!-- Box Head -->
                        <div class="box-head">
                            <h2 class="left"><strong>Sent Record #${stressMeasurement.smId}</strong></h2>
                                            ...
                                            <center>
                                                <center>
                                                    ...
                                                    <table border="0" cellpadding = "2" cellspacing="7" style="float:left; margin-right:25px;margin-left:30px;">
                                                        <tbody>
                                                            ...
                                                            <tr>                            
                                                                <td><label class="tooltip">Locality<span class="tooltiptext">Mine or project where the measurement was done </span></label></td><td><input type="text" id="locality"  name="locality" value="${stressMeasurement.locality}" readonly/> </td>
                                                            </tr>
                                                            <tr> 
                                                                <td><label class="tooltip">Site<span class="tooltiptext">Location on the mine or project where the measurement was done (e.g. 112 level, haulage east).</span></label></td><td><input type="text" id="site"  name="site" value="${stressMeasurement.site}" readonly/></td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Location<span class="tooltiptext">Location of the measurement (e.g. Borehole 2 at 4.5m)</span></label></td><td><input type="text" id="location"  name="location" value="${stressMeasurement.location}" readonly/> </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </center>
                                                <center>
                                                    <table border="0" cellpadding = "2" cellspacing="7" style="float:left; margin-right:25px;">
                                                        <tbody>
                                                            <tr>
                                                                <td><label class="tooltip">Method<span class="tooltiptext">Stress measurement method</span></label></td><td><input type="text" id="method" name="method" value="${stressMeasurement.depth}" readonly/></td>
                                                            ...
                                                            <tr>
                                                                <td><label class="tooltip">Group grade<span class="tooltiptext">Group measurement grading</span></label></td><td><input type="text" id="gg"  name="gg" value="${stressMeasurement.gg}" readonly> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Average grade<span class="tooltiptext">Average of the individual and group grading</span></label></td><td><input type="text" id="avg"  name="avg" value="${stressMeasurement.avg}" readonly/> </td>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <center>
                                                    <table border="0" cellpadding = "2" cellspacing="7" style="float:left; margin-right:25px;">
                                                        <tbody>
                                                            <tr>
                                                                <td><label class="tooltip">Longitude<span class="tooltiptext">Longitude of the stress measurement location </span></label></td><td><input type="text" id="longitude"  name="latitude" value="${stressMeasurement.latitude}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">deg</span> </td>

                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Latitude<span class="tooltiptext">Latitude of the stress measurement location</span></label></td><td><input type="text" id="latitude"  name="latitude" value="${stressMeasurement.latitude}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">deg</span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Depth<span class="tooltiptext">Depth below surface at which the measurement was done</span></label></td><td><input type="text" id="depth"  name="depth" value="${stressMeasurement.depth}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">(m)</span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Expected vertical stress<span class="tooltiptext">Expected vertical stress at the measurement horizon (ρgH or estimated from numerical models)</span></label></td><td><input type="text" id="sob"  name="sob" value="${stressMeasurement.depth}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">MPa</span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Date<span class="tooltiptext">Date when the stress measurement was done</span></label></td><td><input type="text" id="date"  name="date" value="${stressMeasurement.date}" readonly/></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </center>
                                                ...
                                                <fieldset class="inline" style="height: 300px;">
                                                    ...
                                                    <table border="0" cellpadding = "2" cellspacing="7" style="float:left; margin-right:25px;">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td><label class="tooltip">Syy<span class="tooltiptext">Normal stress in Y (Up)</span></label></td><td><input type="text" id="sy"  name="sy" value="${stressMeasurement.sy}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">MPa</span> </td>

                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Szz<span class="tooltiptext">Normal stress in Y (East)</span></label></td><td><input type="text" id="sz"  name="sz" value="${stressMeasurement.sz}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">MPa</span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Sxy<span class="tooltiptext">Shear stress XY</span></label></td><td><input type="text" id="sxy"  name="sxy" value="${stressMeasurement.sxy}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">MPa</span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Syz<span class="tooltiptext">Shear stress YZ</span></label></td><td><input type="text" id="syz"  name="syz" value="${stressMeasurement.syz}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">MPa</span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Sxz<span class="tooltiptext">Shear stress ZX</span></label></td><td><input type="text" id="szx"  name="szx" value="${stressMeasurement.szx}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">MPa</span> </td>
                                                            </tr>
                                                            <tr>                           
                                                ...
                                                <fieldset class="inline" style="height: 300px;">
                                                    ...
                                                    <table border="0" cellpadding = "2" cellspacing="7" style="float:left">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td><label class="tooltip">Ɵ<sub>1</sub><span class="tooltiptext">Bearing angle/azimuth of the major principal stress (anticlockwise from East)</span></label></td><td><input type="text" id="bs1"  name="bs1" value="${stressMeasurement.bs1}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">deg</span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Ɵ<sub>2</sub><span class="tooltiptext">Bearing angle/azimuth of the intermediate principal stress (anticlockwise from East)</span></label></td><td><input type="text" id="bs2"  name="bs2" value="${stressMeasurement.bs2}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">deg</span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Ɵ<sub>3</sub><span class="tooltiptext">Bearing angle/azimuth of the minor principal stress (anticlockwise from East)</span></label></td><td><input type="text" id="bs3"  name="bs3" value="${stressMeasurement.bs3}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">deg</span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">ψ<sub>1</sub><span class="tooltiptext">Dip/plunge of the major principal stress (anticlockwise from horizontal)</span></label></td><td><input type="text" id="dips1"  name="dips1" value="${stressMeasurement.dips1}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">deg</span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">ψ<sub>2</sub><span class="tooltiptext">Dip/plunge of the intermediate principal stress (anticlockwise from horizontal)</span></label></td><td><input type="text" id="dips2"  name="dips2" value="${stressMeasurement.dips2}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">deg</span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">ψ<sub>3</sub><span class="tooltiptext">Dip/plunge of the minor principal stress (anticlockwise from horizontal)</span></label></td><td><input type="text" id="dips3"  name="dips3" value="${stressMeasurement.dips3}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">deg</span> </td>
                                                            </tr>
                                            ...
                                            <center>
                                                <center>
                                                    <table border="0" cellpadding = "2" cellspacing="7" style="float:left; margin-right:20px;">
                                                        <tbody>
                                                            <tr>
                                                                <td><label class="tooltip">Geological sequence<span class="tooltiptext">The geological sequence relevant to the record</span></label></td><td><input type="text" id="seq"  name="seq" value="${stressMeasurement.seq}" readonly/> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Rock type<span class="tooltiptext">The rock type in which the measurement was done</span></label></td><td><input type="text" id="rock"  name="rock" value="${stressMeasurement.rock}" readonly/></td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Comments<span class="tooltiptext">Any additional comments</span></label></td><td><textarea type="text" id="notes"  name="notes" readonly/> ${stressMeasurement.depth}</textarea></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </center>
                                                <center>
                                                    <table border="0" cellpadding = "2" cellspacing="7" style="float:left; margin-right:20px;">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td><label class="tooltip">Young's modulus<span class="tooltiptext">Modulus of elasticity of the rock at the measuring point(GPa)</span></label></td><td><input type="text" id="e"  name="e" value="${stressMeasurement.e}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">GPa</span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Poisson's ratio<span class="tooltiptext">Value of the Poisson’s ratio at the measuring point</span></label></td><td><input type="text" id="pr"  name="pr" value="${stressMeasurement.pr}" readonly></input><span style="margin-left:-35px; color: #bdbdbd;">deg</span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Number of Measurements<span class="tooltiptext">For averaged records, the number of measurements making up the record</span></label></td><td><input type="text" id="no"  name="no" value="${stressMeasurement.no}" readonly/> </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </center>
                                                <center>
                                                    <table border="0" cellpadding = "2" cellspacing="7" style="margin-right: 5px;;">
                                                        <tbody>
                                                            <tr>
                                                                <td><label class="tooltip">Borehole bearing<span class="tooltiptext">Bearing/azimuth of the borehole in which the measurement was done</span></label></td><td><input type="text" id="bhb"  name="bhb" value="${stressMeasurement.bhb}" readonly/></td>

                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Borehole dip<span class="tooltiptext">Dip/plunge of the borehole in which the measurement was done</span></label></td><td><input type="text" id="bhd"  name="bhd" value="${stressMeasurement.bhd}" readonly/> </td>

                                                            </tr>
                                                            <tr>
                                                                <td><label class="tooltip">Source reference<span class="tooltiptext">Reference to the source of the record (document name if the document has been uploaded)</span></label></td><td><input type="text" id="reff"  name="reff" value="${stressMeasurement.reff}" readonly/> </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </center>
