...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" href="css/bootstrap.min.css">
            ...
            <script type="text/javascript">
                function refresh() {
                    window.location = 'measurementList_ad.jsp';
                }
            </script>
            <script>
    ...
    <body><div class="loader"></div>
        ...
        <div id="header">
            <div class="shell">
                ...
                <div id="top">
                    ...
                    <div id="top-navigation"> Welcome <a href="#"><strong>Administrator</strong></a> <span>|</span><a href="#">Profile Settings</a> <span>|</span> <a href="logout.jsp">Log out</a> </div>    </div>
                <!-- End Logo + Top Nav -->
                <!-- Main Nav -->
                <div id="navigation">
                    <ul>
        ...
        <div class="shell">
            <!-- Small Nav -->
            <div class="small-nav"> <a href="measurementList_ad.jsp">Home</a> <span>&gt;</span>Measurements Record </div>
            <!-- End Small Nav -->
        </div>
                        ...
                        <tr>
                            ...
                            <td><div   class="btn-group"><button class="dropdown-toggle button" data-toggle="dropdown"><i class="fa fa-bars "></i> Export Table Data</button>
                                    <ul   class="dropdown-menu " role="menu">
                                        <li><a href="" onClick ="$('#measurements').tableExport({type: 'xml', escape: 'false', ignoreColumn: '[1,47]'});"> <img src='assets/images/icons/xml.png' width='24px'> XML</a></li>
                                        <li><a href="" onClick ="$('#measurements').tableExport({type: 'sql'});"> <img src='assets/images/icons/sql.png' width='24px'> SQL</a></li>
                                        <li><a href="" onClick ="$('#measurements').tableExport({type: 'csv', escape: 'false', footers: 'false', ignoreColumn: '[1,47]'});"> <img src='assets/images/icons/csv.png' width='24px'> CSV</a></li>
                                        <li><a href="" onClick ="$('#measurements').tableExport({type: 'txt', escape: 'false', ignoreColumn: '[1,47]'});"> <img src='assets/images/icons/txt.png' width='24px'> TXT</a></li>
                                        <li><a href="" onClick ="$('#measurements').tableExport({type: 'excel', escape: 'false', footers: false, ignoreColumn: '[0,46]'});"> <img src='assets/images/icons/xls.png' width='24px'> XLS</a></li>
                                        <li><a href="" onClick ="$('#measurements').tableExport({type: 'doc', escape: 'false', footers: 'false', ignoreColumn: '[1,47]'});"> <img src='assets/images/icons/word.png' width='24px'> Word</a></li>
                                    </ul>
                                </div> 
                            </td>
