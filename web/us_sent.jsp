...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <%
            ...
            User recipient = userServise.getUserByUsername(username);
            User sender = userServise.getUserByUsername(username);
        ...
        <div id="container">
            <div class="shell">
                <!-- Small Nav -->
                <div class="small-nav"> <a href="us_notifications.jsp">Notifications</a> <span>&gt;</span>Sent Notifications list</div>
                <!-- End Small Nav -->
                                ...
                                <table width="100%" class="divHeight" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <c:forEach items="${sentMessages}" var="list">
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="readMessage"   href="#"><c:out value="${list.recipientId.getFirstname()}" /></a></td>
                                            <td><h3><a  class="readMessage" href="#"><c:out value="${list.subject}" />.</a></h3></td>
                                            <td class="readMessage" ><c:out value="${date}"/></td>
                                            <td><a></a><a  class="readMessage"  href="us_sent_message.jsp?messageId=${list.messageId}"id="myBtn"  class="ico edit">View</a></td>
                                        </tr>
                                    </c:forEach>
